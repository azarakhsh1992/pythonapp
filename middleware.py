...
def mqtt_client_thread(topic):
    ...
    this_client = mqtt.Client()
    this_client.on_connect = on_connect
    this_client.on_message = on_message

    this_client.connect(broker, 1883, 60)
    this_client.loop_forever()  # Starts network loop
